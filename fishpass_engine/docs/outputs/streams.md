...
| effecitive\_length | double | The raw length for edges, except for the non-core mainstem in flowpaths. This removes the length of skeleton connectors from the analysis. |
...
| upstream\_anthro\_spawn\_ids  | uuid\[\] | The barrier ids of anthropogenic structures that are downstream and spawn impassable for the given species. |
| upstream\_anthro\_rear\_ids  | uuid\[\] | The barrier ids of anthropogenic structures that are downstream and rear impassable for the given species. |
